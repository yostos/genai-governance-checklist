...
- [はじめに ― このガイドラインについて](#はじめに--このガイドラインについて)
- [用語の説明](#用語の説明)
- [第1章　組織の体制と役割](#第1章組織の体制と役割)
- [第2章　使ってよいAIサービス](#第2章使ってよいaiサービス)
- [第3章　AIを使ってよい業務](#第3章aiを使ってよい業務)
- [第4章　AIに入力してはいけない情報](#第4章aiに入力してはいけない情報)
- [第5章　AIの出力を使うときの注意](#第5章aiの出力を使うときの注意)
- [第6章　リスクへの対応](#第6章リスクへの対応)
- [第7章　教育と研修](#第7章教育と研修)
- [第8章　問題が起きたとき](#第8章問題が起きたとき)
- [第9章　ルールを破った場合](#第9章ルールを破った場合)
- [第10章　ガイドラインの運用](#第10章ガイドラインの運用)
- [問い合わせ先](#問い合わせ先)
...
当センターが契約するAIサービスは、
センター事業の予算で運用しています。
委託事業は委託費の中で実施すべきものであり、
センター事業のリソースを委託事業に流用することはできません。
委託事業で取得した情報をAIに入力することも禁止です。

※ これはAI固有の問題ではなく、
事業区分に基づく組織運営の基本原則です。
委託事業でAIを利用する必要がある場合は、
委託元の行政機関と協議の上、
委託費の中で別途手当てしてください。
...
個人情報保護法では、本人から自分の情報について
開示・訂正・削除を求められた場合、対応する義務があります。

しかし、AIサービスに一度入力した情報は、
組織側で完全に削除することが技術的に保証できません。
会話を削除しても、サービス提供者のサーバーに
一定期間データが残る場合があります。

つまり、**個人情報を入力しないことが最大の防御策**です。
入力禁止ルールを守ることが、
本人の権利を守ることに直結しています。

万が一入力してしまった場合の対応は、
第8章「問題が起きたとき」に従ってください。
...
個人情報を入力してしまった場合は、上記に加えて以下も行います。

- 本人への通知が必要かどうかをAI管理責任者が判断します
- サービス提供者に対し、該当データの削除手続きを確認します
- ただし、完全な削除が技術的に保証されない場合があります。
  その旨を正直に記録し、必要に応じて本人にも説明します
