...
- 3.1.B. [Required] 個人情報（氏名、住所、電話番号、メールアドレス等）[JDLA] [FUJITSU]
...
- 3.3.A. [Required] 個人データの入力に関する具体的なルールがある [JDLA] [METI]
  ...
  - **定義例**: 「個人データ（特定の個人を識別できる情報）は原則としてAIに入力し
    ...
    担当者の承認を得る」
- 3.3.B. [Required] 本人同意の要否・取得方法が明記されている [METI] [JDLA]
...
- 3.3.C. [Required] 委託先への提供に該当するかの判断基準がある [METI] [JDLA]
...
- 3.3.D. [Required] 越境移転（海外サーバー利用）への対応が検討されている [METI] [EU-AIA]
